...
def get_paragraph(paragraph: int) -> str:
    if paragraph == 1: 
        return "Mira had always heard voices others could not. They whispered to her in dreams, and sometimes in the quiet moments of waking life. When the orb appeared, the voices grew louder, clearer."
    elif paragraph == 2: 
