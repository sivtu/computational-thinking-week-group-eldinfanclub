...
def get_paragraph(paragraph: int) -> str:
  if paragraph == 1: 
    ...
    return "Startled, Seren dropped the bakstet she was carrying. Apples rolled across the cobblestones, but she barely noticed. The pull toward the woods was undeniable."
  elif paragraph == 3: 
